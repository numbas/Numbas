...
\begin{chapter}{\label{cha:extensions}Extensions}
  ...
  already been defined as part of the \codefile{stats.js} extension file to generate random variables
  ...
  \begin{Verbatim}
	...
	Further examples can be found in the \codefile{stats-extension.exam}, located in the exams directory.
