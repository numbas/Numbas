...
R.registerLocale('nb-NO',{
	...
	'exam.marks available': "Mulige pøng:",
	...
	'control.confirm regen': "Vil du lage nye tilfeldige tall i denne oppgaven? Hvis du klikker OK vil svarene og oppnådde pøng bli annullert.",
	'control.confirm reveal': "Vil du se svarforslag til oppgaven? I så fall vil alle oppnådde pøng bli annullert og du vil ikke kunne svare på spørsmålet senere.",
	...
	'part.marking.steps change single': "Du oppnådde <strong>%s</strong> pøng for delsvarene",
	'part.marking.steps change plural': "Du oppnådde <strong>%s</strong> pøng for delsvarene",
	'part.marking.revealed steps with penalty single': "Du valgte å se svarforslag. Maksimal pøngsum for denne oppgaven er <strong>%s</strong> pøng. Din pøngsum blir dermed redusert.",
	'part.marking.revealed steps with penalty plural': "Du valgte å se svarforslag. Maksimal pøngsum for denne oppgaven er <strong>%s</strong> pøng. Din pøngsum blir dermed redusert.",
	...
	'part.marking.total score single': "Du fikk <strong>%s</strong> pøng for denne oppgaven.",
	'part.marking.total score plural': "Du fikk <strong>%s</strong> pøng for denne oppgaven.",
	...
	'part.mcq.matrix not a number': "Part %s marking matrix cell %s,%s døs not evaluate to a number",
	...
	'question.show steps': "Vis løsning",
	...
	'question.score feedback.answered total actual': "Pøngsum: %(score)/%(marks)",
	'question.score feedback.answered total': "%(marksString). Besvart.",
	'question.score feedback.answered actual': "Pøngsum: %(scoreString)",
	...
	'scorm.failed save': "Skriving av data til serveren feilet. Det er mulig at din økt med svar og pøngsum ikke ble lagret. Vennligst send til <a href=\"mailto:numbas@ncl.ac.uk\">numbas@ncl.ac.uk</a> straks og behold dette vinduet i nettleseren åpent om mulig.",
