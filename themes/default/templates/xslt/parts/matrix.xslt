...
<xsl:template match="part[@type='matrix']" mode="typespecific">
    ...
    <span><matrix-input params="rows: studentAnswerRows, columns: studentAnswerColumns, value: studentAnswer, allowResize: allowResize, minColumns: minColumns, maxColumns: maxColumns, minRows: minRows, maxRows: maxRows, disable: disabled, events: inputEvents, title: input_title"></matrix-input></span>
{% endraw %}
