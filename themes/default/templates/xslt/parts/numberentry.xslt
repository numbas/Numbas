...
<xsl:template match="part[@type='numberentry']" mode="typespecific">
    ...
    <input type="text" step="{answer/inputstep/@value}" class="numberentry" data-bind="event: inputEvents, textInput: studentAnswer, autosize: true, disable: revealed, css: {{'has-error': warningsShown}}"/>
