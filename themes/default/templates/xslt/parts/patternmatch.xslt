...
<xsl:template match="part[@type='patternmatch']" mode="typespecific">
	...
	<input type="text" autocomplete="off" spellcheck="false" class="patternmatch" size="12.5" data-bind="event: inputEvents, textInput: studentAnswer, autosize: true, disable: revealed"></input>
...
<xsl:template match="part[@type='patternmatch']" mode="correctanswer">
	<span class="correct-answer" data-bind="visibleIf: showCorrectAnswer, typeset: showCorrectAnswer">
		...
		<input type="text" autocomplete="off" spellcheck="false" disabled="true" class="patternmatch" data-bind="value: displayAnswer, autosize: true"/>
	</span>
</xsl:template>
{% endraw %}
