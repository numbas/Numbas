...
<xsl:template match="part[@type='patternmatch']" mode="typespecific">
    ...
    <input type="text" autocapitalize="off" inputmode="text" spellcheck="false" class="patternmatch" size="12.5" data-bind="event: inputEvents, textInput: studentAnswer, autosize: true, disable: disabled, attr: {{title: input_title}}, part_aria_validity: hasWarnings, part: $data"/>
{% endraw %}
